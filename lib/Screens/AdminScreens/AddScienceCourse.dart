...
class AddScienceCourse extends StatefulWidget {
  @override
  _AddScienceCourseState createState() => _AddScienceCourseState();
}

class _AddScienceCourseState extends State<AddScienceCourse> {
  var name,
      email,
      phone,
      firsthour,
