...
class AddArabicCourse extends StatefulWidget {
  @override
  _AddArabicCourseState createState() => _AddArabicCourseState();
}

class _AddArabicCourseState extends State<AddArabicCourse> {
  var name,
      email,
      phone,
      firsthour,
