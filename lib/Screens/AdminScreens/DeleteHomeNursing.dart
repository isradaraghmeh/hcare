...
class DeleteHomeNursing extends StatefulWidget {
  @override
  _DeleteHomeNursingState createState() => _DeleteHomeNursingState();
}

class _DeleteHomeNursingState extends State<DeleteHomeNursing> {
