...
class BookingCourseScreen extends StatefulWidget {
  final name,
      email,
      firsthour,
      lasthour,
  ...
  BookingCourseScreen(
      {this.name,
        ...
        this.image});
  @override
  _BookingCourseScreenState createState() => _BookingCourseScreenState();
}

class _BookingCourseScreenState extends State<BookingCourseScreen> {
  ...
  Future<void> _pressMakeAppoinment() async {
    ...
    if (selectedStartDate == null || selectedEndDate == null ) {
      ...
      showFailedDialog(context, "Error Date",
          "Choose other day because employee not work in this day");
      ...
      try {
        ...
        var url = "http://" + ipAdressValue + "/HCare/addcourse.php";
        ...
        if (responsebody['status'] == "success") {
          ...
          Navigator.of(context).pop();
          showFailedDialog(
              context, "Booking success", "Booking done successfully");
          //print("YES");
          ...
          Navigator.of(context).pop();
          showFailedDialog(context, "Booking Failed",
              "Make Booking failed because you have Booking or you requested in this day and time");
        } else {
          Navigator.of(context).pop();
          showFailedDialog(
              context, "Booking Failed", "Make Booking failed");
          //print("NO");
        }
      } catch (e) {
        print(e.toString());
                                ...
                                Container(
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText: 'Enter Course For Grade',
