...
class DeleteArabicCourse extends StatefulWidget {
  @override
  _DeleteArabicCourseState createState() => _DeleteArabicCourseState();
}

class _DeleteArabicCourseState extends State<DeleteArabicCourse> {
  var name,
      email,
      phone,
      firsthour,
