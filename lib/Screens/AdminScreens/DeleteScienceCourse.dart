...
class DeleteScienceCourse extends StatefulWidget {
  @override
  _DeleteScienceCourseState createState() => _DeleteScienceCourseState();
}

class _DeleteScienceCourseState extends State<DeleteScienceCourse> {
  var name,
      email,
      phone,
      firsthour,
