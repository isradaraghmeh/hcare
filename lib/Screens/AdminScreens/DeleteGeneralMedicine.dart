...
class DeleteGeneralMedicine extends StatefulWidget {
  @override
  _DeleteGeneralMedicineState createState() => _DeleteGeneralMedicineState();
}

class _DeleteGeneralMedicineState extends State<DeleteGeneralMedicine> {
...
Future getDataAbout() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title:Text("All Science Teachers"),
       titleSpacing: 0,
      elevation: 0,
