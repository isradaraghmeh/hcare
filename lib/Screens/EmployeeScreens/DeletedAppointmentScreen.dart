...
class DeletedAppointmentScreen extends StatefulWidget {
  @override
  _DeletedAppointmentScreenState createState() =>
      _DeletedAppointmentScreenState();
}

class _DeletedAppointmentScreenState extends State<DeletedAppointmentScreen> {
  var _currntemail = '';
  bool isSignIn = false;
  getPrefrences() async {
  ...
  Future getDataAbout() async {
    ...
    try {
      ...
      var url = "http://"+ipAdressValue+"/HCare/DeletedAppointment.php";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Deleted Private Session'),
        titleSpacing: 0,
        elevation: 0,
              ...
              borderRadius: BorderRadius.circular(15), color: Colors.grey[100]),  padding: EdgeInsets.only(top: 15,bottom: 15,right: 60,left: 10),
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text("Deleted on: " +
                                      snapshot.data[i]['datedelete'],style: TextStyle(color: Theme.of(context).accentColor),),
                                ],
                              ),
                            ),
