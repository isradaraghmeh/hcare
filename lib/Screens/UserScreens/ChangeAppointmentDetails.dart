...
class ChangeAppointmentDetails extends StatefulWidget {
  final date,time,city,region,locationdesc,phonenumber,casedesc,name,cusphone,id;
  ChangeAppointmentDetails({this.date,this.time,this.city,this.region,this.locationdesc,this.phonenumber,this.casedesc,this.name,this.cusphone,this.id});

  @override
  _ChangeAppointmentDetailsState createState() => _ChangeAppointmentDetailsState();
}

class _ChangeAppointmentDetailsState extends State<ChangeAppointmentDetails> {
 ...
 completeDonecorrect(context, String title, String str) {
  ...
  pressSaveChange()async{
   ...
   try {
      ...
      var url = "http://"+ipAdressValue+"/HCare/EditRequestAppointmentInfo.php";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Edit appointment"),backgroundColor:  Theme.of(context).accentColor,titleSpacing: 0,),
      body: Column(
        children: <Widget>[
          Expanded(
