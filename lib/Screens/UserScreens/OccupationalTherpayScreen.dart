...
class OccupationalTherpayScreen extends StatefulWidget {
  @override
  _OccupationalTherpayScreenState createState() =>
      _OccupationalTherpayScreenState();
}

class _OccupationalTherpayScreenState extends State<OccupationalTherpayScreen> {
     var name,
      email,
      phone,
      firsthour,
 ...
 var filterBy = 0;
  ...
  Future getHomeNursingInfo() async {
    try {
      var data = {"CategoryName": "Math"};
      var url = Uri.parse("http://"+ipAdressValue+"/HCare/GetCategoryDescription.php");
  ...
  Future getHomeNursingDoctorInfo() async {
    try {
      var data = {"CategoryName": "Math"};
      var url = Uri.parse("http://"+ipAdressValue+"/HCare/OccupationalDoctor.php");
      var response = await http.post(url, body: data);
      var responsebody = jsonDecode(response.body);
      // print(responsebody);
  ...
  Future getHomeNursingDoctorInfo2() async {
    try {
      var url = "http://" + ipAdressValue + "/HCare/OccupationalDoctor2.php";
